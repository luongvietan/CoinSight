...
export default function FinancialGoals({ goals, onAddGoal, onUpdateGoal, onDeleteGoal }: FinancialGoalsProps) {
        ...
        <CardContent>
          {goals.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-8 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1 max-w-xs">{t.addGoalPrompt}</p>
                ...
                {goals.map((goal) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        ...
                        <Badge variant="outline" className="mt-1">
                          {t.categories[goal.category as keyof typeof t.categories]}
                        </Badge>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-3 text-sm">
                      ...
                      <div>
                        <p className="text-muted-foreground">{t.currentAmount}</p>
                    ...
                    {goal.deadline && (
                      <p className="text-xs text-muted-foreground mt-2">
                        {t.deadline}:{" "}
                        {new Date(goal.deadline).toLocaleDateString(language === "vi" ? "vi-VN" : "en-US")}
                      </p>
                    )}
                  </motion.div>
                ))}
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader className="flex flex-row items-center justify-between">
            <DialogTitle>{editingGoal ? t.editGoalTitle : t.addGoalTitle}</DialogTitle>
            <DialogClose asChild>
            ...
            <div className="grid gap-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="purchase">{t.categories.purchase}</SelectItem>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSaveGoal} disabled={!formData.name || !formData.targetAmount}>
              {t.saveGoalButton}
            </Button>
          </DialogFooter>
        </DialogContent>
