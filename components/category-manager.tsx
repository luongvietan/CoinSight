...
export default function CategoryManager({ categories, onCategoriesChange, defaultCategories }: CategoryManagerProps) {
  ...
  const handleUpdateCategory = () => {
    ...
    if (
      categories.some((c) => c.id !== editingCategory.id && c.name.toLowerCase() === editingCategory.name.toLowerCase())
    ) {
      toast({
        title: "Category already exists",
        variant: "destructive",
                  ...
                  {colorOptions.map((color) => (
                    <button
                      ...
                      className={cn(
                        ...
                        newCategoryColor === color ? "ring-2 ring-offset-2 ring-ring" : "",
                      )}
                  ...
                  {categories.map((category) => (
                    <motion.div
                      ...
                      className={cn(
                        ...
                        editingCategory?.id === category.id ? "ring-2 ring-ring" : "",
                      )}
                    >
                      {editingCategory?.id === category.id ? (
                        <div className="flex items-center gap-2 w-full">
                          <div className="w-4 h-4 rounded-full" style={{ backgroundColor: editingCategory.color }} />
                          <Input
                          ...
                          <div className="flex items-center">
                            <Button size="icon" variant="ghost" className="h-7 w-7" onClick={handleUpdateCategory}>
