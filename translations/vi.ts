export const vi = {
  ...
  common: {
    ...
    errorLoadingData: "Không thể tải dữ liệu. Vui lòng thử lại sau.",
    errorSavingData: "Không thể lưu dữ liệu. Vui lòng thử lại.",
    errorDeletingData: "Không thể xóa dữ liệu. Vui lòng thử lại.",
  },
  header: {
  ...
  budgetTracking: {
    ...
    confirmDeleteBudget: "Bạn có chắc chắn muốn xóa ngân sách này không?",
